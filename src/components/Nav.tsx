...
export const Nav = () => {
  ...
  return ( 
    <header className="w-full sticky bg-midnight text-sand flex justify-between items-center shadow-sm group font-altdisplay" role="banner">
      <div className="">
        <Link to="/" className="flex justify-center items-center gap-2 p-2 md:p-4 sm:ml-4" aria-label="Home">
          ...
          <span className="font-bold font-altdisplay md:text-2xl">Mind Matters Memphis</span>
        </Link>
      </div>
