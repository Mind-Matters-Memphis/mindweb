  ...
  return ( 
    <div className="grid sm:grid-cols-9 justify-center bg-sage text-midnight py-4 relative">
      ...
      <div className="sm:col-start-2 sm:col-span-7 p-4 lg:p-0">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 lg:grid-rows-4 justify-center justify-items-center py-12 z-10 relative">
          <div className="lg:col-start-2 lg:row-span-4 self-center xl:px-8 2xl:px-16">
          <img src={portrait} alt="Dr. Gould professional headshot" className="object-cover object-top rounded-3xl shadow-xl"/>
          </div>
          ...
          <div className="p-4 xl:p-8 text-xl text-start flex flex-col gap-4 row-span-2">
            <p className="">Dr. Gould has been providing excellent care in clinical neuropsychology for XX years.</p>
            <p>She founded Mind Matters Memphis to [insert goal statement].</p>
          </div>
