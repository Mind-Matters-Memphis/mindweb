...
const NavMenu: React.FC<NavMenu> = () => (
  <NavigationMenu.Root className="hidden relative z-50 lg:flex w-screen bg-midnight text-sand text-2xl shadow-sm group font-accessdisplay">
    <NavigationMenu.List className="flex w-screen items-center">
