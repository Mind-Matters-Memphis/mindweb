  ...
  return ( 
    <div className="bg-dust flex justify-center p-4 sm:p-8">
      <div className="text-midnight bg-dust p-4 grid gap-4 justify-center relative rounded-bl-xl text-xl max-w-[500px] md:gap-8 md:max-w-[800px]">
        <h2 className="text-4xl sm:text-6xl md:text-7xl text-center font-accessdisplay font-bold uppercase">Refer a Patient</h2>
        ...
        <button className="bg-dust/80 font-bold text-2xl p-4 m-4 sm:p-6 sm:px-12 border-2 border-midnight w-fit h-fit justify-self-center rounded-lg transition-all ease-in-out duration-200 relative shadow-md active:left-[1px] active:top-[2px] active:shadow-none">Download Referral Form</button>
      </div>
    </div>
  );
}