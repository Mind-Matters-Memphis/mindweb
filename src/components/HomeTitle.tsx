  ...
  return ( 
    <div className="h-dvh lg:h-2/3 relative">
      ...
      <div className="absolute top-1/4 left-4 text-center bg-midnight bg-opacity-85 p-8 px-6 rounded-md">
        <h1 className="text-4xl font-bold text-sand flex gap-2 underline decoration-coral decoration-double pb-4 font-display" title="Mind Matters Memphis">Mind Matters Memphis</h1>
        <ul className="font-altdisplay text-2xl">
          <li>
